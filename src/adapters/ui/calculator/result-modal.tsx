...
export function ResultModal({ prevExpression, result, particles, smoke, onDismiss }: ResultModalProps) {
  return (
    <div
      onClick={onDismiss}
      style={{
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          borderRadius: 22,
          boxShadow: "12px 12px 0 rgba(0,0,0,.6), 0 0 70px var(--calc-glow, #a3e635)",
      ...
      >
        ...
        <div style={{ fontFamily: "'Silkscreen'", fontSize: 12, color: "#7f9a86", wordBreak: "break-all", textAlign: "center" }}>
          {prevExpression}
        </div>
        <div
          style={{
